...
try {
  ...
  assert.equal(headerStatusControls, 2, "header status area should use compact framework route demo controls");
  ...
  assert.equal(await desktop.locator("[data-fastdas-working-set-route]").getAttribute("data-fastdas-working-set-route"), "command-center", "adding a synthetic opportunity should move to Command Center");
